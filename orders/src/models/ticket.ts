...
const INCREMENT_CURRENT_VERSION = 1;
...
ticketSchema.set("versionKey", "version");
 ...
 // Replace for updateIfCurrentPlugin
// ticketSchema.pre("save", function (done) {
//   this.$where = {
//     version: this.get("version") - INCREMENT_CURRENT_VERSION,
//   };
...
ticketSchema.statics.findByEvent = (event: { id: string; version: number }) => {
  return Ticket.findOne({
    _id: event.id,
    version: event.version - INCREMENT_CURRENT_VERSION,
  });
};
